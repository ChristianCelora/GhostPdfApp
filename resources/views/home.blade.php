...
<div class="container">
    <div class="row justify-content-center">
        <div class="d-flex flex-lg-row flex-column box p-2 div-link" id="box1" data-location="{{route('view.v_compress')}}">
        ...
        <div class="d-flex flex-lg-row flex-column box p-2 div-link" id="box2" data-location="{{route('view.v_cut')}}">
            <div class="flex-column">
        ...
        <div class="d-flex flex-lg-row flex-column box p-2 div-link" id="box3" data-location="{{route('view.v_secure')}}">
            <div class="flex-column">
